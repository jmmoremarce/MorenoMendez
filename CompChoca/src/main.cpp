...
/** \mainpage RoboComp::torpedo
 *
 * \section intro_sec Introduction
 *
 * The torpedo component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/torpedo --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	torpedo (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::torpedo::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
